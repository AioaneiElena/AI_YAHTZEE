...
def get_chatbot_response(user_message):
    ...
    elif "strategie" in user_message or "strategii" in user_message:
        return (
            "Strategii: \n"
    ...
    elif "puncte" in user_message or "punct" in user_message or "joc" in user_message or "jocuri" in user_message:
        return (
